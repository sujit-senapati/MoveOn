            ...
            <div className='flex justify-between items-center flex-col'>
                ...
                <div className='fixed w-full bottom-0 flex flex-col justify-center items-end p-5 '>
                    <form
                        ...
                        <input
                            className='rounded-sm font-mono w-full border-gray-200 border-1 text-center p-2 font-semibold'
                            type="number" placeholder='Enter OTP' />
                        <div className='w-full flex items-center justify-between'>
                            <Link to="/captain-home" className='w-full mt-5 text-center bg-black border-1 border-black active:bg-gray-800 text-white font-semibold p-2 rounded-sm'>Finish ride</Link>
                        </div>
                    </form>
                </div>
            </div>
